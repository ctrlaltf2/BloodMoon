...
public class EntityGiantZombie extends net.minecraft.server.v1_12_R1.EntityGiantZombie {

    private BloodMoon plugin;
    private BloodMoonEntityGiantZombie bloodMoonEntity;

    public EntityGiantZombie(net.minecraft.server.v1_12_R1.World world) {
        super(world);
